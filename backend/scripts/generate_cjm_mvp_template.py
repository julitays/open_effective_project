...
VALIDATION_OPTIONS: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("01_Паспорт проекта", "Операционная модель"): (
        "Мерчендайзинг",
    ...
    ("04_История опросов", "Тип опроса"): ("Блиц", "Операционный"),
    ("04_История опросов", "Тональность"): (
        "Позитивная",
        "Нейтральная",
        "Негативная",
        "Смешанная",
    ...
    ("06_Ожидания клиента", "Тип ожидания"): (
        "Скорость",
        "Качество",
        "Отчетность",
        "Инициативность",
    ...
    ("06_Ожидания клиента", "Явное или неявное"): (
        "Явное",
        "Неявное",
        "Неизвестно",
    ),
    ("08_Каналы взаимодействия", "Канал"): (
        "Встреча",
        "Звонок",
        "Почта",
        "Мессенджер",
    ...
    ("08_Каналы взаимодействия", "Частота"): (
        "По запросу",
        "Еженедельно",
        "Раз в две недели",
        "Ежемесячно",
    ...
    ("09_Планы устранения", "Тип действия"): (
        "Устранение",
        "Сдерживание",
        "Профилактика",
        "Эскалация",
...
def _add_instruction_sheet(workbook: Workbook) -> None:
    ...
    rows = (
        ...
        ("Лист 10 хранит вопросы, которые нужно дозапросить для следующего шага.",),
    )
