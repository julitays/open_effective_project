...
class CJMReadRepository:
    ...
    def list_projects(self) -> list[Project]:
        return list(self.session.scalars(select(Project).order_by(Project.project_code)).all())
    ...
    def list_lprs(self, project_id: object) -> list[LPRProfile]:
        statement = (
            ...
            .where(LPRProfile.project_id == project_id)
    ...
    def list_barriers(self, project_id: object) -> list[ProjectBarrier]:
        statement = (
            ...
            .where(ProjectBarrier.project_id == project_id)
    ...
    def list_expectations(self, project_id: object) -> list[ClientExpectation]:
        statement = (
            ...
            .where(ClientExpectation.project_id == project_id)
    ...
    def list_kpis(self, project_id: object) -> list[ProjectKPI]:
        statement = (
            select(ProjectKPI)
            .where(ProjectKPI.project_id == project_id)
    ...
    def list_communications(self, project_id: object) -> list[CommunicationPoint]:
        statement = (
            ...
            .where(CommunicationPoint.project_id == project_id)
